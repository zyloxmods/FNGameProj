...
void UBuildingTextureDataThumbnailRenderer::Draw(UObject* Object, int32 X, int32 Y, uint32 Width, uint32 Height, FRenderTarget* Viewport, FCanvas* Canvas)
{
	...
	if (BuildingTextureData)
	{
		...
		{
			Super::Draw(BuildingTextureData->Diffuse, X, Y, Width, Height, Viewport, Canvas);
		}
	}
}
