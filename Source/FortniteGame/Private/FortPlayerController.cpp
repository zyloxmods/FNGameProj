...
AFortPlayerController::AFortPlayerController() {
    this->bAllowPcbBenefits = true;
    this->bInPossession = false;
    this->AircraftInputComponent = NULL;
    this->SkydiveMusicAudioComp = NULL;
    ...
    this->TimeStartedWaiting = 1;
    this->TimeFinishedNavigationBuild = 1;
    this->MaterialParameterCollection = NULL;
    this->bLoadingScreenDropped = false;
    this->LastActiveTime = 1;
    this->bRevertPlayerListenerChange = true;
    ...
    this->ReturnToMainMenuTimeoutDelay = 1;
    this->LastDamager = NULL;
    this->LastFallInstigator = NULL;
    this->LastDamagerCreditThresholdDropElim = 1;
    this->LastDamagerCreditThresholdSelfElim = 1;
    this->LastDamagerCreditThresholdStormElim = 1;
    ...
    this->bHoldingObject = false;
    this->DBNOCarryInputComponent = NULL;
    this->HeldObjectsInputComponent = NULL;
    ...
    this->bShowHitMarkersForFriendlyFire = false;
    ...
    this->bRequireTraceToExistingBuildingToSetContext = false;
    this->bAllowTraceToExistingBuildingToSetContextToRedirectToBlockingBuilding = true;
    this->bRequireTraceToExistingBuildingToSetContextExcludeCurrentContext = true;
    ...
    this->bServerAutoChangeMaterial = true;
    this->bPeripheralLightingEnabled = false;
    this->bRudderControlEnabled = false;
    this->RudderDeadZone = 1;
    this->RudderMaxThrottle = 1;
    this->bSyncPeripheralLightingWithEmoteMusic = true;
    this->bPushEmoteAudioDataToCosmeticMaterials = true;
    this->LastEmoteMusicFFT100hz = 1;
    this->LastEmoteMusicFFT2000hz = 1;
    this->EmoteMusicBeatThreshold = 1;
    ...
    this->ClientSideEditPredictionTimeout = 1;
    this->PendingEnterEditModeActor = NULL;
    this->RandomCharacterIndex = 0;
    this->AntiAddictionPlayTimeMultiplier = 1;
    this->bSupportQuickEdit = false;
    this->bQuickEditEnabled = true;
    ...
    this->BattleMapSpectatorClass = NULL;
    this->bReleaseBuildingContextOnPlace = true;
    this->TurboPlaceFirstInterval = 1;
    this->TurboPlaceInterval = 1;
    this->bCreativeTurboDelete = true;
    this->TurboDeleteFirstInterval = 1;
    this->TurboDeleteInterval = 1;
    this->bTurboBuild = true;
    this->TurboBuildFirstInterval = 1;
    this->TurboBuildRequestFailedInterval = 1;
    this->TurboBuildInterval = 1;
    this->FortControllerComponent_Telemetry = CreateDefaultSubobject<UFortControllerComponent_Telemetry>(TEXT("TelemetryComp"));
    this->InventoryNetworkManagementComponent = CreateDefaultSubobject<UFortControllerComponent_InventoryNetworkManagement>(TEXT("InventoryManagementComp"));
    this->InteractionComponent = CreateDefaultSubobject<UFortControllerComponent_Interaction>(TEXT("InteractionComp"));
    this->CollectionsComponent = CreateDefaultSubobject<UFortControllerComponent_Collections>(TEXT("CollectionsComp"));
    this->PendingExecuteInventoryItemDefinition = NULL;
    this->QuickHealItemPickerClass = NULL;
}
