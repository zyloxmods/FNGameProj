...
AFortGameState::AFortGameState() {
    ...
    this->CurrentReadyToContinueTimer = 1;
    this->TeamCount = 0;
    this->GameFlagData = 0;
    this->PoiManager = NULL;
    this->bDBNOEnabledForGameMode = true;
    this->bPlayersAlwaysVisible = false;
    this->bSkipWorldSave = false;
    this->bShowLoadingScreenUntilAllLevelAreLoaded = false;
    this->bPlayerRespawningBlocked_Temporarily = false;
    ...
    this->UnplayableHitchThresholdInMs = 1;
    this->MaxUnplayableHitchesToTolerate = 0;
    this->CreativeQuestManager = NULL;
}
