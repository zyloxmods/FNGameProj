...
AFortGameStateZone::AFortGameStateZone() {
    this->PawnIDCount = 0;
    this->WaitingToLeaveZoneTimeLeft = 0;
    this->HostilityMeterPercent = 1;
    this->IntensityPercent = 1;
    this->SpawnPointsCap = 0;
    this->SpawnPointsAllocated = 0;
    this->MaxTotalAI = 0;
    this->MaxEncounterAI = 0;
    this->MaxEncounterSP = 0;
    this->CompletionResult = EFortCompletionResult::Win;
    this->PlayerBuildingSkillLevel = 1;
    ...
    this->bAllowedToOverrideBackendRewards = false;
    ...
    this->ServerStability = EServerStability::Stable;
    this->CreativePortalManager = NULL;
    this->CreativeRealEstatePlotManager = NULL;
    this->bUseMaxBackpackSize = false;
}
