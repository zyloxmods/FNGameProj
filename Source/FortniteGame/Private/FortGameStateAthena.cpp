...
AFortGameStateAthena::AFortGameStateAthena() {
    this->bCanBuildOnWaterGlobal = true;
    this->bBlockBuildOnWaterGlobal = false;
    this->bPlaylistDataIsLoaded = false;
    this->bPlaylistDataIsActivelyLoading = false;
    this->PlaylistEndTime = 1;
    this->SafeZonePauseTime = 1;
    this->TotalFinalCountdownTime = 0;
    this->bForceTeamScorePlacementOnDeath = false;
    this->bPlaylistStoppedSafeZonePhases = false;
    this->bSkyTubesShuttingDown = false;
    this->bSkyTubesDisabled = false;
    this->ServerChangelistNumber = 0;
    this->SpecialActorData = NULL;
    this->ReplOverrideData = NULL;
    this->bSkipWinnerAnnounced = false;
    this->bStopBuildingHealingOnDamage = false;
    this->bIsInCountdown = false;
    this->bIsInFinalCountdown = false;
    this->WarmupCountdownStartTime = 1;
    this->WarmupCountdownEndTime = 1;
    this->AircraftStartTime = 1;
    this->SafeZonesStartTime = 1;
    this->EndGameStartTime = 1;
    this->EndGameKickPlayerTime = 1;
    this->TotalPlayers = 0;
    this->PlayersLeft = 0;
    this->RemainingFocalPointActorDuration = 1;
    ...
    this->SplatterGridSystem = NULL;
    this->CustomizationsPreloader = NULL;
    this->GamePhase = EAthenaGamePhase::None;
    this->EventTournamentRound = EEventTournamentRound::Open;
    this->bIsCustomMatch = false;
    this->bGameModeWillSkipAircraft = false;
    this->SafeZonePhase = 0;
    this->GamePhaseStep = EAthenaGamePhaseStep::None;
    this->GamePhaseStepTimeRemaining = 1;
    this->LobbySoundMix = NULL;
    this->TotalPlayersBots = 0;
    ...
    this->FortGameStateComponent_Telemetry = CreateDefaultSubobject<UFortGameStateComponent_Telemetry>(TEXT("TelemetryComponent"));
    this->ActiveEventManager = CreateDefaultSubobject<UFortGameStateComponent_ActiveEventManager>(TEXT("ActiveEventManager"));
    this->DefaultGliderRedeployCanRedeploy = 1;
    this->DefaultRedeployGliderLateralVelocityMult = 1;
    this->DefaultRedeployGliderHeightLimit = 1;
    this->DefaultParachuteDeployTraceForGroundDistance = 1;
    this->DefaultAllowNeutralWallEditing = 1;
    this->DefaultRebootMachineHotfix = 1;
    this->SignalInStormRegenSpeed = 1;
    this->SignalInStormLostSpeed = 1;
    this->StormCNDamageVulnerabilityLevel0 = 1;
    this->StormCNDamageVulnerabilityLevel1 = 1;
    this->StormCNDamageVulnerabilityLevel2 = 1;
    this->StormCNDamageVulnerabilityLevel3 = 1;
    this->bFishingCollectionEnabled = true;
    this->VolumeManagerToUse = NULL;
    this->VolumeManager = NULL;
    this->LocalizationService = NULL;
    this->EliminationMarkerHUDMaxDistance = 1;
    this->EliminationMarkerHUDZOffset = 1;
    this->UnicornDriver = NULL;
    this->SmoothedWorldTimeSeconds = 1;
    this->SmoothedWorldTimeSecondsDrift = 1;
    this->bEnvironmentDamageBlocked = false;
    this->bDamageComboHUDEnabled = true;
    this->DamageComboHUDMinHits = 0;
}
