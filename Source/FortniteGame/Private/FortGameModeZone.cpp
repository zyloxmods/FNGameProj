...
AFortGameModeZone::AFortGameModeZone() {
    ...
    this->StormWindInactiveMagnitudeScalar = 1;
    this->StormWindActiveMagnitudeScalar = 1;
    this->bEnableLongRangeAutoPickup = false;
    this->LongRangeAutoPickupInterval = 1;
    this->LongRangeAutoPickupRadius = 1;
}
