...
AFortPlayerStateAthena::AFortPlayerStateAthena() {
    ...
    this->DownScore = 0;
    this->KillScore = 0;
    this->SeasonLevelUIDisplay = 0;
    this->HumanKillScore = 0;
    this->AIKillCount = 0;
    ...
    this->bDidNotThankBusDriver = false;
