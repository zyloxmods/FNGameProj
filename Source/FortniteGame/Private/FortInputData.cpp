...
UFortInputData::UFortInputData() {
    ...
    this->GamepadToggleHarvestWeaponOrAltInteractName = TEXT("GamepadToggleHarvestWeaponOrAltInteract");
    ...
    this->GamepadNextWeaponOrAltInteractOrHarvestHoldName = TEXT("GamepadNextWeaponOrAltInteractOrHarvestHold");
    ...
    this->DBNOCarryHoistName = TEXT("DBNOCarryHoist");
    this->AlternateInteractCarryName = TEXT("AlternateInteractCarry");
    ...
    this->CreativeQuickbarActivateClutchName = TEXT("CreativeQuickbarActivateClutch");
    ...
    this->EndOfZonePickerConfirmName = TEXT("EndOfZonePickerConfirm");
    ...
    this->GolfCartHonkName = TEXT("GolfCartHonk");
    this->GamepadQuadCrasherForwardName = TEXT("GamepadQuadCrasherForward");
    this->GamepadQuadCrasherReverseName = TEXT("GamepadQuadCrasherReverse");
    this->QuadCrasherHonkName = TEXT("QuadCrasherHonk");
    ...
    this->BiplanePitchForward = TEXT("BiplanePitchForward");
    this->BiplanePitchForwardSecondary = TEXT("BiplanePitchForwardSecondary");
    ...
    this->GamepadBiplanePitchForward = TEXT("BiplanePitchForward_Gamepad");
    ...
    this->OstrichBoostName = TEXT("OstrichBoost");
    this->GamepadOstrichBoostName = TEXT("GamepadOstrichBoost");
    this->OstrichJumpName = TEXT("OstrichJump");
    this->GamepadOstrichJumpName = TEXT("GamepadOstrichJump");
    this->OstrichPrimaryFireName = TEXT("OstrichPrimaryFire");
    this->GamepadOstrichPrimaryFireName = TEXT("GamepadOstrichPrimaryFire");
    this->OstrichSecondaryFireName = TEXT("OstrichSecondaryFire");
    this->GamepadOstrichSecondaryFireName = TEXT("GamepadOstrichSecondaryFire");
    this->OstrichShieldBoostName = TEXT("OstrichShieldBoost");
    this->GamepadOstrichShieldBoostName = TEXT("GamepadOstrichShieldBoost");
    this->OstrichSelfDestructName = TEXT("OstrichSelfDestruct");
    this->GamepadOstrichSelfDestructName = TEXT("GamepadOstrichSelfDestruct");
    this->TogglePickAxeName = TEXT("TogglePickAxe");
    this->ToggleCreativePhoneName = TEXT("ToggleCreativePhone");
    this->ToggleQuickMenuName = TEXT("ToggleQuickMenu");
    ...
    this->CreativePossessPropActivateName = TEXT("PossessPropActivate");
    ...
    this->CreativeToggleHeatmapName = TEXT("CreativeToggleHeatmap");
    ...
    this->InputOptionsList.AddDefaulted(173);
}
