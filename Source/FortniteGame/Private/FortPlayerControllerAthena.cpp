...
AFortPlayerControllerAthena::AFortPlayerControllerAthena() {
    this->FireAbilityToWeaponSwitchTime = 1;
    this->SwappingItemDefinition = NULL;
    this->WinScreenDelayTime = 1;
    this->bSkipPlayWinEffects = false;
    this->bAllowPlayersCreditOnLeave = true;
    this->FocalPoint = NULL;
    this->FocalPointFOV = 1;
    this->FocalPointDuration = 1;
    this->SkydiveLeaderManualCameraTime = 1;
    this->SkydiveLeader = NULL;
    this->LastDownedVictim = NULL;
    this->LastElimVictim = NULL;
    ...
    this->HighlightFirstKillTime = 1;
    this->HighlightKillMultiple = 0;
    this->HighlightDownMultiple = 0;
    this->HighlightKillCooldown = 1;
    this->HighlightKillRewindTime = 1;
    this->RespawnCamera_Time = 1;
    this->RespawnCamera_HoldPositionTime = 1;
    this->bNextRespawnInAir = false;
    this->MaximumNumberOfPawnsToSearchForEmoteMusic = 0;
    this->PickupSwapHoldTime = 1;
    this->bUseNewPickupSwapLogic = true;
    this->SpectatorLevelStreamDistance = 1;
    this->RespawnLevelStreamDistance = 1;
    this->RespawnCameraActor = NULL;
    this->bDelayedTeleporting = false;
    this->bBlockTeleporting = false;
    this->MaxPlotCount = 0;
    this->bNoInGameMatchmaking = false;
    this->AudioOnExitAircraft = NULL;
    this->AudioOnExitAircraftHornDoppler = NULL;
    this->MinQuickChatCooldown = 1;
    this->QuickChatOffCooldownTime = 1;
    this->bMarkedAlive = false;
    this->bIsAllowedToPublish = false;
    this->MapCursorSpeed = 1;
    this->MapCursorSpeedGamepad = 1;
    this->bMatchStatsForPlayerSent = false;
    this->bAddedBookProgressStatsToGamemode = false;
    ...
    this->EndMatchHeartbeatTimerDelay = 1;
    this->EndMatchHeartbeatTimestamp = 4294967295;
    ...
    this->GameChannelRecommendationInputComponent = NULL;
    this->SubscriptionNudgeInputComponent = NULL;
    this->BattleLabInputComponent = NULL;
    this->bUseTrapPicker = false;
    this->DoubleTapEditTime = 1;
    this->MatchReport = NULL;
    this->MinimapIndicatorClass = NULL;
    this->MinimapChallengeIndicatorClass = NULL;
    this->MinimapChallengeIndicators = NULL;
    this->bEnableInGameChallengeLocationIndicators = false;
    ...
    this->BuildingActionDoneLastAtTime = 1;
    this->TimeStartedTrackingBuildingAnalytics = 1;
    this->CreativePlotLinkedVolume = NULL;
    this->OwnedPortal = NULL;
    this->CurrentPlayset = NULL;
    this->DestructedBuildingInGridTimeoutOverride = 1;
    ...
    this->HeldDeviceUsageComponent = CreateDefaultSubobject<UFortControllerComponent_HeldDeviceUsage>(TEXT("HeldDeviceUsageComponent"));
    this->XPComponent = CreateDefaultSubobject<UFortPlayerControllerAthenaXPComponent>(TEXT("XPComponent"));
    this->DiscoverabilityComponent = CreateDefaultSubobject<UFortControllerComponent_MapDiscoverability>(TEXT("DiscoverabilityComponent"));
    this->SkydiveFeedback = CreateDefaultSubobject<UFortControllerComponent_SkydiveFeedback>(TEXT("SkydiveFeedbackComponent"));
    this->ContextualChallenges = CreateDefaultSubobject<UFortControllerComponent_ContextualChallenges>(TEXT("ContextualChallenges"));
    this->IndicatedActorManagementComponent = CreateDefaultSubobject<UFortControllerComponent_IndicatedActorManagement>(TEXT("IndicatedActorManagementComponent"));
    this->LocalizationServiceComponent = CreateDefaultSubobject<UFortControllerComponent_LocalizationService>(TEXT("LocalizationServiceComponent"));
    this->ToxicityServiceComponent = CreateDefaultSubobject<UFortControllerComponent_ToxicityService>(TEXT("ToxicityServiceComponent"));
    this->RechargingWeaponsComponent = CreateDefaultSubobject<UFortControllerComponent_RechargeWeapons>(TEXT("RechargeWeaponsComponent"));
    this->MinigameActivityComponent = CreateDefaultSubobject<UFortControllerComponent_MinigameActivity>(TEXT("MinigameActivityComponent"));
    this->TimeSinceLastCreativeSpawn = 4294967295;
    this->bIgnoreSignifanceBasedCustomDepthRendering = false;
    this->CreativeUserContentManager = NULL;
    this->CreativeObjectTrackingComponent = NULL;
    this->CreativeItemToRemoveWhenAddingInventoryItem = NULL;
}
