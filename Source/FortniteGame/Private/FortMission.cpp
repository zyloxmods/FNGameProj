...
AFortMission::AFortMission() {
    ...
    this->BotLogic = NULL;
    this->AnnouncementClassOverride = NULL;
    ...
    this->bAreNonpublicMatchesLeecherExempt = false;
    this->LeecherPity = 1;
    this->LeecherMinMultiplier = 1;
    this->LeecherCutoff = 1;
    this->LeecherTimeScalingCutoff = 1;
    this->LeecherTimeScalingPenaltyMultipler = 1;
    this->LeecherCombatScoreMultiplier = 1;
    this->LeecherBuildingScoreMultiplier = 1;
    this->LeecherUtilityScoreMultiplier = 1;
    this->LeecherCombatLowBar = 0;
    this->LeecherBuildingLowBar = 0;
    this->LeecherUtilityLowBar = 0;
    this->MissionActivationTime = 1;
    ...
    this->ChosenRewardIdx = 0;
    this->MissionCompletionStinger = NULL;
}
