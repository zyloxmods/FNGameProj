...
AFortMinigame::AFortMinigame() {
    ...
    this->CurrentRound = 0;
    this->TotalRounds = 0;
    this->bRemovePawnOnDeath = false;
    this->PlayerDeathsStatFilter = NULL;
    this->bKeepItemsBetweenRounds = false;
    this->PercentageOfResourcesKeptBetweenRounds = 1;
    this->bReloadAndRestockWeaponsEachRound = false;
    this->DefaultRestockAmmoAmount = 0;
    this->bLastTeamStandingWins = false;
    this->bAllowStandardEndGameConditions = true;
    this->bEndGameOnMatchPointWin = false;
    ...
    this->WarmupDuration = 1;
    this->PostGameResetDelay = 1;
    this->GameWinnerDisplayTime = 1;
    this->GameScoreDisplayTime = 1;
    this->RoundWinnerDisplayTime = 1;
    this->RoundScoreDisplayTime = 1;
    this->ServerEndgameDelay = 1;
    ...
    this->ScoreStatFilter = NULL;
    this->LapTimeStatFilter = NULL;
    this->TimeAliveStatFilter = NULL;
    this->DefaultClassSlot = 255;
    this->ClassResetType = EFortMinigameClassResetType::Never;
    this->MaxLivesForPlayer = 0;
    this->TeamToSwapToWhenOutOfSpawns = 0;
    this->AutoEndTeamThreshold = 0;
    this->bStopwatchMode = false;
    this->LastRoundDuration = 1;
    this->CreatureManagerComponent = CreateDefaultSubobject<UFortCreativeCreatureManagerComponent>(TEXT("CreatureManagerComponent"));
    this->TeleporterManagerComponent = CreateDefaultSubobject<UFortCreativeTeleporterManagerComponent>(TEXT("TeleporterManagerComponent"));
    this->CreativePlayerHealthComponent = CreateDefaultSubobject<UCreativePlayerHealthInfoComponent>(TEXT("PlayerHealthComponent"));
    this->Volume = NULL;
    this->bSortScoreboardEntries = true;
    this->bTeamMinigame = false;
    this->bTeamsAreStable = false;
    this->NumTeams = 0;
    this->bAllowJoinInProgress = false;
    this->PlayerPersistence = EMinigamePlayerPersistence::None;
    this->MinigameStarter = NULL;
    this->TeamRotationSetting = 0;
    this->TeamRotationCount = 0;
    this->bStableTeamCosmetics = false;
    this->MinigameMapWidget = EMinigameFullscreenMapWidgetType::Default_Map;
    this->WinCondition = EMinigameWinCondition::MostRoundWins;
    this->bAllTeamsMustMatchEndConditions = false;
    this->bOnlyAllowRespawningIfPlayerStartPadsFound = false;
    this->GameEndCallout = EMinigameGameEndCallout::WinLose;
    this->VictoryAudioIndex = 0;
    this->DrawAudioIndex = 0;
    this->DefeatAudioIndex = 0;
    this->bShowCumulativeScoreboard = false;
    ...
    this->NumMinigameComponentsServer = 0;
