...
AFortCreativeMoveTool::AFortCreativeMoveTool() {
    this->CreativeMoveToolInputComponent = CreateDefaultSubobject<UFortObjectMoverInputComponent>(TEXT("MoveToolInputComponent"));
    this->MaxRange = 1;
    this->ActiveMovementMode = NULL;
    this->bIsPreviewingMove = false;
    this->DeleteObjectsInteractionBehavior = NULL;
    this->PlaysetPreviewInteractionBehavior = NULL;
    ...
    this->MaxUnhoverAnimationTime = 1;
    ...
    this->GridSnapRatios.AddDefaulted(6);
    this->bDoesRequireCreatePermission = true;
    this->TraceType = EHitTraceType::Single;
    this->bClientNeedsToProcessNewlyPlacedActors = false;
    this->ActiveRecordSpawner = NULL;
    this->bAlwaysMoveFreely = false;
