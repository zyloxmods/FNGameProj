...
AFortTimeOfDayManager::AFortTimeOfDayManager() {
    ...
    this->TransitionBlendPercent = 1;
    this->DefaultTimeOfDaySpeed = 1;
    this->StartTimeOfDayInGame = 1;
    this->TimeOfDaySpeed = 1;
    this->MaxTimeOfDayAccumulationFactor = 1;
    this->TimeOfDayAccumulator = 1;
    ...
    this->SunObjectDivergencePower = 1;
    this->bUseSkyAtmosphereRotationAndDivergence = false;
    this->SkyAtmosphereRotationDivergencePower = 1;
    this->DistanceToSunOrMoon = 1;
    ...
    this->LightAndFogOverridesFadeTime = 1;
    this->CurrentLightAndFogBlendValue = 1;
    ...
    this->OverridePostProcessComponent = NULL;
