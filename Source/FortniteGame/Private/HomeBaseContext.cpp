...
bool UHomeBaseContext::GetTotalHomebaseRating(const FUniqueNetIdRepl& UniqueId, int32& Rating, float& ProgressFraction) const {
    return false;
}

bool UHomeBaseContext::GetTeamHomebaseRating(const FUniqueNetIdRepl& PlayerID, int32& Rating, float& ProgressFraction) const {
    return false;
}
...
bool UHomeBaseContext::DoesTeamMeetRequiredHomebaseRating(int32 RequiredHomebaseRating) const {
    return false;
}
