...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetTotalHomebaseRating(const FUniqueNetIdRepl& UniqueId, int32& Rating, float& ProgressFraction) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetTeamHomebaseRating(const FUniqueNetIdRepl& PlayerID, int32& Rating, float& ProgressFraction) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool DoesTeamMeetRequiredHomebaseRating(int32 RequiredHomebaseRating) const;
