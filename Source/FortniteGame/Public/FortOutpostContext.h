...
#include "OnCraftingTableActivationBonusChangedDelegate.h"
...
class FORTNITEGAME_API UFortOutpostContext : public UBlueprintContextBase {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnCraftingTableActivationBonusChanged OnCraftingTableActivationBonusChanged;
