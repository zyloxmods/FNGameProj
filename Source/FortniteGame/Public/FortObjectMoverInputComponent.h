...
#include "OnCreativeQuickbarActionDelegate.h"
...
class FORTNITEGAME_API UFortObjectMoverInputComponent : public UActorComponent {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnCreativeQuickbarAction OnCreativeQuickbarPressed;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnCreativeQuickbarAction OnCreativeQuickbarReleased;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnCreativeInput OnCreativeQuickbarSelectNext;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnCreativeInput OnCreativeQuickbarSelectPrevious;
    
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnCreativeInput OnCreativeQuickbarClearFocusedSlotPressed;
