...
class FORTNITEGAME_API AFortClientAnnouncement_TutorialConversation : public AFortClientAnnouncement_Conversation, public IFortClientAnnouncement_TutorialInterface {
    GENERATED_BODY()
public:
