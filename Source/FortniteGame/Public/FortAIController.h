...
class FORTNITEGAME_API AFortAIController : public AAIController, public IFortTeamActorInterface, public INavPathObserverInterface, public IFortAIEncounterInfoOwnerInterface {
    GENERATED_BODY()
public:
