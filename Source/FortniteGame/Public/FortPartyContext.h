...
public:
    ...
    DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnFriendsCountChangedDelegate, int32, ActiveFriendsCount);
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnFriendsCountChangedDelegate OnActiveFriendsCountUpdated;
...
private:
    ...
    TArray<UFortSocialUser*> FriendsNeedingPartyUpdate;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void ShowExternalProfile(const FUniqueNetIdRepl& ProfileToShow);
    
    UFUNCTION(BlueprintCallable)
    void ShowExternalFriendsUI();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool ShouldShowExternalFriendsUI() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool ShouldShowCrossplayWarningDialog() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool ShouldMcpPartyInvitesBeEnabled() const;
    ...
    UFUNCTION(BlueprintCallable)
    void SetLocalPartyMemberEmoting(const UFortMontageItemDefinitionBase* EmoteAsset);
    
    UFUNCTION(BlueprintCallable)
    void SendTeamMemberFriendRequest(const FFortTeamMemberInfo& TeamMemberInfo);
    
    UFUNCTION(BlueprintCallable)
    void SendPartyInviteNetID(const FUniqueNetIdRepl& PlayerID);
    
    UFUNCTION(BlueprintCallable)
    void SendMcpFriendRequest(const FUniqueNetIdRepl& PlayerID);
    
    UFUNCTION(BlueprintCallable)
    void SendConsoleFriendRequest(const FUniqueNetIdRepl& PlayerID);
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool IsPlayerInOurParty(const FUniqueNetIdRepl& PlayerIdToCheck) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool IsInLocalPlayersParty(const FUniqueNetIdRepl& PlayerID) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool IsEntirePartyInFrontEnd() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool HasPendingMcpPartyInvitation(const FUniqueNetIdRepl& PlayerID) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool CanShowExternalProfile(const FString& TargetPlatform) const;
    
    UFUNCTION(BlueprintCallable)
    bool CanBeInvitedNetID(const FUniqueNetIdRepl& PlayerID);
