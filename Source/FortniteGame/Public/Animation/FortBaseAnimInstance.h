...
public:
	...
	UPROPERTY(EditAnywhere)
	bool bUseSkydivingVectorForce = false; // 0x00(0x01)
	...
	UPROPERTY(EditAnywhere)
	bool bUseNoisyClothGravity = false; // 0x64(0x01)

	UPROPERTY(EditAnywhere)
	bool bApplyNoiseInActorSpace = false; // 0x65(0x01)
