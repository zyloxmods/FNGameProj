...
bool UFortGlobalUIContext::HasCompletedOnboardingObjective(const FDataTableRowHandle& Objective) const {
    return false;
}
...
FName UFortGlobalUIContext::GetVehicleUseOrExitActionName(const ECommonInputType OverrideInputType) const {
    return NAME_None;
}

FName UFortGlobalUIContext::GetVehicleJumpActionName(const ECommonInputType OverrideInputType) const {
    return NAME_None;
}

FName UFortGlobalUIContext::GetVehicleExitActionName(const ECommonInputType OverrideInputType) const {
    return NAME_None;
}

FName UFortGlobalUIContext::GetVehicleChangeSeatActionName() const {
    return NAME_None;
}
...
UFortGlobalUIContext::UFortGlobalUIContext() {
    ...
    this->bIsAllContentInstalledCache = false;
}
