...
void UFortFrontEndContext::ViewVaultItemsFromOffer(const FCatalogOffer& CatalogOffer, bool bIgnoreCurrentlyEquppedFavorites) {
}

void UFortFrontEndContext::ViewVaultItems(const TArray<UFortItem*>& ItemsToView, bool bIgnoreCurrentlyEquppedFavorites) {
}

void UFortFrontEndContext::ViewVaultItemFromDefinition(const UFortItemDefinition* ItemToViewDefinition, bool bIgnoreCurrentlyEquppedFavorites) {
}

void UFortFrontEndContext::ViewVaultItem(UFortItem* ItemToView, bool bIgnoreCurrentlyEquppedFavorites) {
}
...
void UFortFrontEndContext::SetLocalVariantPreview(const UAthenaCosmeticItemDefinition* CosmeticItem, FGameplayTag VariantChannelTag, FGameplayTag VariantTag) {
}
...
FName UFortFrontEndContext::GetLobbyBackgroundLevelName() const {
    return NAME_None;
}
