...
TArray<FFortDisplayAttribute> UFortTooltipUIContext::GetUpgradeStats(const UObject* Object, UFortTooltipContext* TooltipContext, bool bUseSummaryTooltip) const {
